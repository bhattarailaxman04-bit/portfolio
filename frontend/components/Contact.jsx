        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a href="https://github.com/bhattarailaxman04-bit" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100 hover:bg-slate-900 hover:border-slate-900 transition-all group">
